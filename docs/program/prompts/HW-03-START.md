# Prompt — Start HW-03 Tauri 可信桌面壳与统一 Workspace Web
...
- docs/program/phases/HW-03-desktop-web-shell.md
- docs/program/tasks/HW-03.yaml
...
13. After all tasks pass, run phase-level Sol agents: sol_architecture_security, sol_phase_gate.
