# Prompt — Start HW-09 Agent Gateway、Coordinator／Worker 与受控协作
...
- docs/program/phases/HW-09-agent-collaboration.md
- docs/program/tasks/HW-09.yaml
...
13. After all tasks pass, run phase-level Sol agents: sol_acceptance, sol_architecture_security, sol_phase_gate.
